...
export default function MyPortfolio() {
  ...
  return (
    <section className="portfolio--section" id="MyPortfolio" style={styles.section}>
      <div className="portfolio--container-box">
        <div className="portfolio--container">
          <h2 className="section--heading" style={styles.heading}>Messages</h2>
        </div>
      </div>
      
      {/* Elfsight YouTube Section */}
      <div className="youtube-embed-section" style={styles.youtubeSection}>
        <div className="elfsight-app-c25037f8-538e-4998-9c1b-0af02b8d85ad"></div>
      </div>
    </section>
  );
}
